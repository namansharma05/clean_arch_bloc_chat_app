...
import 'package:clean_arch_bloc_chat_app/features/individual_chat/presentation/widgets/individual_chat_body_widget.dart';
    ...
    return Builder(
      builder: (context) {
        ...
        return PopScope(
          ...
          child: Scaffold(
            appBar: const IndividualChatAppBarWidget(),
            body: const IndividualChatBodyWidget(),
